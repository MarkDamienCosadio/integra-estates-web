      ...
      <div className="section-4-module__KR0FYq__inner container">
        ...
        >
          ...
          <div className="property-slide-swiper-module__ZWA3Ca__swiperControls">
            <button type="button" onClick={() => swiperInst?.slidePrev()} className="property-slide-swiper-module__ZWA3Ca__swiperBtn" aria-label="Previous">
            ...
            <div className="property-slide-swiper-module__ZWA3Ca__swiperPagination" style={{ width: '120px' }} aria-live="polite"></div>
            <button type="button" onClick={() => swiperInst?.slideNext()} className="property-slide-swiper-module__ZWA3Ca__swiperBtn" aria-label="Next">
