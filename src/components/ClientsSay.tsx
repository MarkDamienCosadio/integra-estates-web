      ...
      <div className="section-4-module__KR0FYq__inner container">
        ...
        >
          ...
          <div className="property-slide-swiper-module__ZWA3Ca__swiperControls">
            <button type="button" onClick={handlePrevClick} className="property-slide-swiper-module__ZWA3Ca__swiperBtn" aria-label="Previous">
              ←
            </button>
            ...
            <button type="button" onClick={handleNextClick} className="property-slide-swiper-module__ZWA3Ca__swiperBtn" aria-label="Next">
              →
            </button>
          </div>
        </div>
